...
import static com.callib.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.callib.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.callib.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    private void init(Context context) {
        ...
        smallIndicatorRadius = 5.0f * screenDensity;
                ...
                if (shouldDrawIndicatorsBelowSelectedDays || (!shouldDrawIndicatorsBelowSelectedDays  )||animationStatus == EXPOSE_CALENDAR_ANIMATION) {
                    if (eventIndicatorStyle == FILL_LARGE_INDICATOR || eventIndicatorStyle == NO_FILL_LARGE_INDICATOR) {
                        ...
                        if (!eventsList.isEmpty()) {
                            ...
                            Log.i("SZ","T::"+event.getTimeInMillis());
            ...
            if (dayRow == 0) {
                ...
                if (day <= 0) {
                    if (displayOtherMonthDays) {
                        // compactCalendarShouldSelectFirstDayOfMonthOnScrollDisplay day month before
                        dayPaint.setStyle(Paint.Style.FILL);
    ...
    private void drawCircle(Canvas canvas, float radius, float x, float y) {
        ...
        /*canvas.drawText("Diwali", x, y+50, dayPaint);
        dayPaint.setTypeface(Typeface.DEFAULT);*/
    }
}
